...
trainData["Family"] = trainData$Parch+trainData$SibSp+1

trainData["Mother"] = 2
trainData$Mother[trainData$Name=="Mrs" & trainData$Parch > 0] = 1

train.glm <- glm(Survived ~ Pclass + Sex + Age + Child + Pclass + Family + Mother, family = binomial, data = trainData)
